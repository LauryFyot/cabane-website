...
<div class="w-full flex-grow flex justify-center items-center py-10">
    <div class="w-10/12 flex justify-center items-center relative h-[530px] max-w-[1200px]">
        ...
        <div id="app" class="absolute w-full h-full mx-auto transition-all duration-500 ease-linear">
            <div class="relative">
                <div class="slides-container w-full h-full mx-auto snap-x snap-mandatory gap-8  overflow-y-hidden flex items-center justify-start scroll-smooth relative pb-4">
                    ...
                    <article class="slide overflow-hidden rounded-lg shadow-md transition hover:shadow-lg hover:shadow-gray-300 w-1/3 min-w-[270px] slide hors-vacances-scolaires snap-start">
                                ...
                                <div class="slide w-full rounded transition">
                                    ...
                                    <div class="flex flex-row justify-between w-full price-2p">
                                        ...
                                        <div class="flex flex-col justify-center items-center w-1/2">
                                            ...
                                            <h1 class="font-extrabold text-transparent text-xl bg-clip-text bg-gradient-to-r from-[#88B181] to-[#365031]">205€</h1>
                                            <p class="text-xs text-gray-900">/2pers</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex-row justify-around w-full price-full-week-2p hidden">
                                        <div class="flex flex-col justify-center items-center">
                                            ...
                                            <h1 class="font-extrabold text-transparent text-xl bg-clip-text bg-gradient-to-r from-[#88B181] to-[#365031]">695€</h1>
                                            <p class="text-xs text-gray-900">/2pers</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex-row justify-around w-full price-full-week-4p hidden">
                                        <div class="flex flex-col justify-center items-center">
                                            <p class="text-xs font-semibold">Forfait semaine</p>
                                            <h1 class="font-extrabold text-transparent text-xl bg-clip-text bg-gradient-to-r from-[#88B181] to-[#365031]">725€</h1>
                                            <p class="text-xs text-gray-900">/4pers</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- Vacances scolaires -->
                    <article class="slide overflow-hidden rounded-lg shadow-md transition hover:shadow-lg hover:shadow-gray-300 w-1/3 min-w-[270px] snap-center slide vacances-scolaires">
                        <img alt="Office" src="assets/img/WE insolite.webp" class="h-56 w-full object-cover" />

                        <div class="bg-white p-4 sm:p-6">
                            <h3 class="mt-0.5 text-lg font-semibold text-gray-900 mb-2">Vacances Scolaires</h3>
                    ...
                    <!-- Jours feriés -->
                    <article class="slide overflow-hidden rounded-lg shadow-md transition hover:shadow-lg hover:shadow-gray-300 w-1/3 min-w-[270px] slide jours-feries snap-end">
                        <img alt="Office" src="assets/img/Cabane pres de Paris.webp" class="h-56 w-full object-cover" />

                        <div class="bg-white p-4 sm:p-6">
                            <h3 class="mt-0.5 text-lg font-semibold text-gray-900 mb-2">Jours feriés</h3>
